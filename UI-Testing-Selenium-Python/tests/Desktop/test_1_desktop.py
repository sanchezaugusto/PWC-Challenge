...
def test_main1(driver):
    ...
    # Arrange   
    base_page_obj.configHome(APP_URL, DEVICE["desktop"])
    base_page_obj.wait_for_element( By.ID, SIGNIN_ID)
    driver.find_element(By.ID, SIGNIN_ID).click()

    # Act
    base_page_obj.wait_for_element(By.LINK_TEXT, REGISTER_LINK_TEXT)
    driver.find_element(By.LINK_TEXT, REGISTER_LINK_TEXT).click()

    base_page_obj.wait_for_element(By.XPATH, SEND_BUTTON_SELECTOR)
   ...
   # Asserts
    base_page_obj.wait_for_element( By.XPATH, REG_DATA_XPATH)
